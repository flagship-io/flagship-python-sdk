...
class FlagshipVisitor:
    ...
    def synchronize_modifications(self):
        ...
        if self._config.mode is Config.Mode.API:
            ...
            self.campaigns = Bucketing.synchronize_modifications(self._config, self._visitor_id, self._context)
        self._api_client.send_context_request(self._visitor_id, self._context)
    ...
    def get_modification_info(self, key):
        ...
        if key in self._modifications:
            ...
            self._config.event_handler.on_log(logging.ERROR, "[get_modification_info] Key {} is not in any campaign."
                                              .format(key))
            return None
