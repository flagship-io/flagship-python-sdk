...
from flagship.constants import _TAG_PARSING_CAMPAIGNS, _ERROR_PARSING_CAMPAIGN
        ...
        try:
            ...
            if bucketing:
                for variation_group_obj in variation_groups_obj:
                    variation_groups.append(VariationGroup.parse(campaign_id, variation_group_obj, True))
            else:
            ...
            log_exception(_TAG_PARSING_CAMPAIGNS, FlagshipParsingError(_ERROR_PARSING_CAMPAIGN), traceback.format_exc())
            return None
